...
public class ModelLoader : MonoBehaviour
{
    ...
    public void ToggleModel(int idx, bool value)
    {
        if (models[idx] == null)
        {
            ...
            models[idx].GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>().selectEntered.AddListener(measureLine.select);
            models[idx].GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>().selectExited.AddListener(measureLine.select);
        }
